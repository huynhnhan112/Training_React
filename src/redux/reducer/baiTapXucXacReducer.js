...
const stateDefault = {
    soBanChoi:0,
    soBanThang:0,
    banChon:true, // Tài true Xiu false
    mangXucXac: [
        {hinhAnh: './img/gameXucXac/gameXucXac/2.png',diem:2},
        {hinhAnh: './img/gameXucXac/gameXucXac/1.png',diem:1},
        {hinhAnh: './img/gameXucXac/gameXucXac/1.png',diem:1},
    ]
}
...
export const baiTapGameXucXacReducer = (state = stateDefault,action) => {
    ...
    switch(action.type){
        ...
        case 'PLAY_GAME':{
            ...
            for(let i = 0; i < 3; i++){
                // Mỗi lần chạy tạo ra 1 số ngẫu nhiên
                let soNgauNhien = Math.floor(Math.random() * 6) + 1;
                // Từ số ngẫu nhiên tạo ra 1 object xúc xắc ngẫu nhiên
                let xxnn = {hinhAnh: `./img/gameXucXac/gameXucXac/${soNgauNhien}.png`,diem:soNgauNhien};
